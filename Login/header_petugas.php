...
<body>
    ...
    <div class="container-fluid">
        <a class="navbar-brand" href="#">SERBA ADA</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="../Login/home_petugas.php">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="../Produk/produk_petugas.php">Produk</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="../Produk/histori_pembelian_petugas.php">Histori</a>
                </li>
                <li class="nav-item">
